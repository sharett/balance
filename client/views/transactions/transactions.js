...
Template._transactions.helpers({
...
Template._filter_month.helpers({
	'selected': function () {
	  return _.isEqual(Session.get("transaction_filter_month"), this);
	},
});

Template._filter_month.events({
	'click': function () {
...
Template._filter_member.helpers({
	'selected': function () {
	  return Session.equals("transaction_filter_member", this._id);
	},
});

Template._filter_member.events({
	'click': function () {
